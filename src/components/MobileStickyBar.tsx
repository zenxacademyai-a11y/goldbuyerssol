      ...
      <div className="flex items-center justify-between gap-2 max-w-lg mx-auto">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <a
            ...
            className="flex items-center justify-center gap-1 bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 text-neutral-950 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold shadow-md whitespace-nowrap transition-transform active:scale-95 no-underline shrink-0"
          >
