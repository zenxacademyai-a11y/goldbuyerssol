...
const aboutTranslations = {
  en: {
    ...
    missionText: "To empower gold sellers in Sri Lanka by providing a completely transparent, zero-stress appraisal experience with zero hidden fees, utilizing state-of-the-art XRF spectrometers and government-calibrated scales.",
